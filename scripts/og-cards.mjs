...
export const TOOLS = {
  ...
  koiPond: {
    out: 'koi-pond-calculator-tool-card.png',
    eyebrow: 'FREE TOOL',
    icon: '\u{1FAB7}',
    title: 'Koi Pond Calculator',
    sub: 'Pond volume in gallons and litres, plus koi capacity and pump flow.',
    chips: ['Gallons', 'Litres', '4 shapes'],
    fields: [
      ['Pond shape', 'Rectangular'],
      ['Length (ft)', '12'],
    ],
    input: ['Average depth (ft)', '3.5'],
    cta: 'Calculate Pond Volume',
    result: ['2,513 US gal', '9,514 litres \u00b7 holds 10 adult koi'],
  },
  koiStocking: {
    out: 'koi-pond-stocking-tool-card.png',
    eyebrow: 'FREE TOOL',
    icon: '\u{1F41F}',
    title: 'Koi Stocking Calculator',
    sub: 'How many koi your pond holds once the fish reach adult size.',
    chips: ['250 gal/koi', 'Adult size', 'Filtration'],
    fields: [
      ['Koi size', 'Adult 13\u201318 in'],
      ['Filtration', 'Good'],
    ],
    input: ['Pond volume (US gal)', '1,000'],
    cta: 'Calculate Stocking',
    result: ['4 koi maximum', 'Stock 3 to leave room for growth'],
  },
  koiPump: {
    out: 'koi-pond-pump-tool-card.png',
    eyebrow: 'FREE TOOL',
    icon: '\u{1F300}',
    title: 'Koi Pond Pump Calculator',
    sub: 'GPH at the head height your pump really works against.',
    chips: ['Turnover', 'Head loss', 'Pipe size'],
    fields: [
      ['Turnover', 'Once per hour'],
      ['Vertical lift (ft)', '4'],
    ],
    input: ['Pond volume (US gal)', '3,000'],
    cta: 'Calculate Pump Size',
    result: ['3,000 GPH @ 5.9 ft', 'Not the same as a 3,000 GPH box rating'],
  },
  koiLiner: {
    out: 'koi-pond-liner-tool-card.png',
    eyebrow: 'FREE TOOL',
    icon: '\u{1F4D0}',
    title: 'Koi Pond Liner Calculator',
    sub: 'Liner sheet size, underlay and weight from your pond dimensions.',
    chips: ['Sheet size', 'Underlay', 'EPDM weight'],
    fields: [
      ['Pond length (ft)', '12'],
      ['Max depth (ft)', '4'],
    ],
    input: ['Overlap per side (ft)', '1'],
    cta: 'Calculate Liner Size',
    result: ['22 \u00d7 18 ft', 'Buy the 25 \u00d7 20 ft standard sheet'],
  },
  koiSalt: {
    out: 'koi-pond-salt-tool-card.png',
    eyebrow: 'FREE TOOL',
    icon: '\u{1F9C2}',
    title: 'Koi Pond Salt Calculator',
    sub: 'Exact pond salt dosage in pounds and kilograms, split safely.',
    chips: ['0.1%', '0.3%', '0.5%'],
    fields: [
      ['Target level', '0.3% (3 ppt)'],
      ['Salt already in pond', '0%'],
    ],
    input: ['Pond volume (US gal)', '1,000'],
    cta: 'Calculate Salt Dose',
    result: ['25.0 lb \u00b7 11.4 kg', 'Split into 2 doses over 2 days'],
  },
  koiFeeding: {
    out: 'koi-feeding-tool-card.png',
    eyebrow: 'FREE TOOL',
    icon: '\u{1F37D}',
    title: 'Koi Feeding Calculator',
    sub: 'Daily food weight set by water temperature, not by the calendar.',
    chips: ['By temperature', 'Grams', 'Food type'],
    fields: [
      ['How many koi', '6'],
      ['Average length (in)', '14'],
    ],
    input: ['Water temperature (\u00b0F)', '72'],
    cta: 'Calculate Feeding',
    result: ['97.1 g per day', '3 feeds \u00b7 growth food \u00b7 peak season'],
  },
  feeding: {
